 ...
 ***************************************************************/
	...
	suds.addListener('connect', function(){
		...
		console.log('connecting to suds');
	...
	suds.addListener('data', function(data){
		...
		{
			console.log(get_time() + ' - malformed json');
			console.log("\t" + data.toString());
		}
		...
		{
			status = recv;
			console.log(get_time() + ' - update stall');
			console.log(status);
			send_to_all(recv);
		}
	...
	suds.addListener('end', function(){
		console.log(get_time() + ' - soap server connection terminated');

	});
	
	suds.addListener('error', function(e){
		console.log(get_time() + ' soap server connection ended');
	});
...
socket.on('connection', function(client){ 
	...
	***************************************************************/
  	...
  	client.on('message', function(recv_message){
		console.log("----------------------------");
		console.log(get_time() + ' - socket.io: ' + recv_message);	
		console.log("----------------------------");
	...
	client.on('disconnect', function(){
		console.log("----------------------------");
		console.log(get_time() + ' - socket.io: client disconnected')
		console.log("----------------------------");
